...
postup tvorby pr?hlednıch stín? a jejich problémy a moné ?ešení.
...
vytvo?í se?azená mnoina hran s t?etím nehranovım vrcholem a id trojuhelníku. Hrany jsou se?azeny
 podle vrcholu 1, pak vrcholu 2 a nakonec podle id trojuhelníku. Toto se?azení umo?uje aby kadou 
sdílenou hranu pak zpracovával jen jeden trojuhelník (ten s nejniším id).
...
poadovaná délka extrudovaného stínu. V compute a geometry shaderech jsou tyto data v SSBO strukturách
(krom? pozice sv?tla a délky stínu - ty jsou oby?ejné uniformy).
 
Pro kadı trojuhelník, pokud je p?ivrácenı ke sv?tlu, se vygeneruje novı extrudovanı o p?íslušnou vzdálenost
od sv?tla. Pro kadou jeho hranu se nalezne trojuhelník s nejniším indexem, kterı ji obsahuje a podle
...
Kole?ko - p?iblíení/oddálení pohledu ve scén?
